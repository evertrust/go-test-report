...
[![goreportcard](https://goreportcard.com/badge/github.com/evertrust/go-test-report)](https://goreportcard.com/report/github.com/evertrust/go-test-report)
...
```shell
$ go get -u github.com/evertrust/go-test-report/
```
